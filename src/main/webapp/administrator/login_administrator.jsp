					...
					<div class="container">
						<div class="row">
							<div class="col-12 d-flex justify-content-center align-content-center">
								...
								<form action="<%=request.getContextPath()%>/administrator/adminLogin" method="post">

									<h2>管理者登入</h2>

									<label for="administratorAccount">管理者帳號：</label>
									<input type="email" id="administratorAccount" name="administratorAccount" placeholder="請輸入帳號"
										required>
									<div class="tab"></div>

									<label for="administratorPassword">密碼：</label>
									<input type="password" id="administratorPassword" name="administratorPassword" placeholder="請輸入密碼"
										required>
									<div class="tab"></div>
									<br>
